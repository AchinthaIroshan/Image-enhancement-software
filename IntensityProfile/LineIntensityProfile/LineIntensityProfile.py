...
class LineIntensityProfile(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.categories = [" Point Operations"]
    self.parent.dependencies = []
    self.parent.contributors = ["Achintha Iroshan (University of Moratuwa.)"] # replace with "Firstname Lastname (Organization)"
...
class LineIntensityProfileLogic(ScriptedLoadableModuleLogic):
  ...
  def showChart(self,samples,names):
    ...
    for sample in samples:
        ...
        #get the chart view MRML nodeTypes
